...
static rapidjson::Value serializeNonTrivialObject(
    const MeasSubframePattern_r10::MeasSubframePattern_r10_u::MeasSubframePattern_r10__subframePatternTDD_r10& obj,
    auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(
    const MeasDS_Config_r12::MeasDS_Config_r12_u::MeasDS_Config_r12__setup& obj, auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const MeasDS_Config_r12::MeasDS_Config_r12_u::MeasDS_Config_r12__setup::
        MeasDS_Config_r12__setup__dmtc_PeriodOffset_r12& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const MeasDS_Config_r12::MeasDS_Config_r12_u::MeasDS_Config_r12__setup::
        MeasDS_Config_r12__setup__ds_OccasionDuration_r12& obj,
    auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(const RMTC_Config_r13::RMTC_Config_r13_u::RMTC_Config_r13__setup& obj,
                                                  auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(const MeasObjectUTRA::MeasObjectUTRA__cellsToAddModList& obj,
                                                  auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(const MeasObjectUTRA::MeasObjectUTRA__cellForWhichToReportCGI& obj,
                                                  auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(const CarrierFreqsGERAN::CarrierFreqsGERAN__followingARFCNs& obj,
                                                  auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const CarrierFreqsGERAN::CarrierFreqsGERAN__followingARFCNs::CarrierFreqsGERAN__followingARFCNs_u::
        CarrierFreqsGERAN__followingARFCNs__equallySpacedARFCNs& obj,
    auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(const MeasObjectWLAN_r13::MeasObjectWLAN_r13__carrierFreq_r13& obj,
                                                  auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigEUTRA::ReportConfigEUTRA__triggerType::ReportConfigEUTRA__triggerType_u::
        ReportConfigEUTRA__triggerType__periodical& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const ThresholdEUTRA& obj, auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigEUTRA::ReportConfigEUTRA__triggerType::ReportConfigEUTRA__triggerType_u::
        ReportConfigEUTRA__triggerType__event::ReportConfigEUTRA__triggerType__event__eventId& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigEUTRA::ReportConfigEUTRA__triggerType::ReportConfigEUTRA__triggerType_u::
        ReportConfigEUTRA__triggerType__event& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const ReportConfigEUTRA::ReportConfigEUTRA__triggerType& obj,
                                                  auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigEUTRA::ReportConfigEUTRA__alternativeTimeToTrigger_r12& obj, auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const RSRQ_RangeConfig_r12& obj, auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigEUTRA::ReportConfigEUTRA__rs_sinr_Config_r13::ReportConfigEUTRA__rs_sinr_Config_r13_u::
        ReportConfigEUTRA__rs_sinr_Config_r13__setup& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const ReportConfigEUTRA::ReportConfigEUTRA__rs_sinr_Config_r13& obj,
                                                  auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const MeasRSSI_ReportConfig_r13& obj, auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const UL_DelayConfig_r13::UL_DelayConfig_r13_u::UL_DelayConfig_r13__setup& obj, auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__periodical& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const ThresholdUTRA& obj, auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event::ReportConfigInterRAT__triggerType__event__eventId::
            ReportConfigInterRAT__triggerType__event__eventId_u::
                ReportConfigInterRAT__triggerType__event__eventId__eventB1::
                    ReportConfigInterRAT__triggerType__event__eventId__eventB1__b1_Threshold& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event::ReportConfigInterRAT__triggerType__event__eventId::
            ReportConfigInterRAT__triggerType__event__eventId_u::
                ReportConfigInterRAT__triggerType__event__eventId__eventB1& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event::ReportConfigInterRAT__triggerType__event__eventId::
            ReportConfigInterRAT__triggerType__event__eventId_u::
                ReportConfigInterRAT__triggerType__event__eventId__eventB2::
                    ReportConfigInterRAT__triggerType__event__eventId__eventB2__b2_Threshold2& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event::ReportConfigInterRAT__triggerType__event__eventId::
            ReportConfigInterRAT__triggerType__event__eventId_u::
                ReportConfigInterRAT__triggerType__event__eventId__eventB2& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event::ReportConfigInterRAT__triggerType__event__eventId::
            ReportConfigInterRAT__triggerType__event__eventId_u::
                ReportConfigInterRAT__triggerType__event__eventId__eventW1_r13& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event::ReportConfigInterRAT__triggerType__event__eventId::
            ReportConfigInterRAT__triggerType__event__eventId_u::
                ReportConfigInterRAT__triggerType__event__eventId__eventW2_r13& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event::ReportConfigInterRAT__triggerType__event__eventId::
            ReportConfigInterRAT__triggerType__event__eventId_u::
                ReportConfigInterRAT__triggerType__event__eventId__eventW3_r13& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event::ReportConfigInterRAT__triggerType__event__eventId& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__triggerType::ReportConfigInterRAT__triggerType_u::
        ReportConfigInterRAT__triggerType__event& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const ReportConfigInterRAT::ReportConfigInterRAT__triggerType& obj,
                                                  auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const ReportConfigInterRAT::ReportConfigInterRAT__b2_Threshold1_v1250& obj, auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(const ReportConfigToAddMod::ReportConfigToAddMod__reportConfig& obj,
                                                  auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(
    const MeasGapConfig::MeasGapConfig_u::MeasGapConfig__setup::MeasGapConfig__setup__gapOffset& obj, auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const MeasGapConfig::MeasGapConfig_u::MeasGapConfig__setup& obj,
                                                  auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(
    const MeasConfig::MeasConfig__speedStatePars::MeasConfig__speedStatePars_u::MeasConfig__speedStatePars__setup& obj,
    auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(
    const MeasObjectToAddModExt_r13::MeasObjectToAddModExt_r13__measObject_r13& obj, auto& alloc);
...
static rapidjson::Value serializeNonTrivialObject(
    const MeasGapConfigPerCC_List_r14::MeasGapConfigPerCC_List_r14_u::MeasGapConfigPerCC_List_r14__setup& obj,
    auto& alloc);
static rapidjson::Value serializeNonTrivialObject(const MeasGapConfigPerCC_List_r14& obj, auto& alloc);
static rapidjson::Value serializeNonTrivialObject(
    const MeasGapSharingConfig_r14::MeasGapSharingConfig_r14_u::MeasGapSharingConfig_r14__setup& obj, auto& alloc);
...
template <typename T, typename Alloc,
          typename ValueType = std::remove_cvref_t<decltype(**std::declval<T>().list.array)>>
static rapidjson::Value serializeASequence(const T* seq, Alloc& alloc) {
  rapidjson::Value result;
  result.SetObject();
  std::vector<ValueType> valueVector;
  std::copy_n(*seq->list.array, seq->list.count, std::back_inserter(valueVector));
...
static rapidjson::Value serializeNonTrivialObject(const MeasSubframePatternConfigNeigh_r10& obj, auto& alloc) {
  ...
  case MeasSubframePatternConfigNeigh_r10_PR_setup:
    ...
    result.AddMember("measSubframeCellList_r10", serializeASequence(obj.choice.setup.measSubframeCellList_r10, alloc),
                     alloc);
    break;
...
static rapidjson::Value serializeNonTrivialObject(const MeasSubframePattern_r10& obj, auto& alloc) {
  ...
  case MeasSubframePattern_r10_PR_subframePatternFDD_r10:
    result.AddMember("subframePatternFDD_r10", serializeBitString(obj.choice.subframePatternFDD_r10, alloc), alloc);
    break;
  case MeasSubframePattern_r10_PR_subframePatternTDD_r10:
    result.AddMember("subframePatternTDD_r10", serializeNonTrivialObject(obj.choice.subframePatternTDD_r10, alloc),
                     alloc);
    break;
...
static rapidjson::Value serializeNonTrivialObject(
  ...
  case MeasSubframePattern_r10__subframePatternTDD_r10_PR_subframeConfig1_5_r10:
    result.AddMember("subframeConfig1_5_r10", serializeBitString(obj.choice.subframeConfig1_5_r10, alloc), alloc);
    break;
  case MeasSubframePattern_r10__subframePatternTDD_r10_PR_subframeConfig0_r10:
    result.AddMember("subframeConfig0_r10", serializeBitString(obj.choice.subframeConfig0_r10, alloc), alloc);
    break;
  case MeasSubframePattern_r10__subframePatternTDD_r10_PR_subframeConfig6_r10:
    result.AddMember("subframeConfig6_r10", serializeBitString(obj.choice.subframeConfig6_r10, alloc), alloc);
    break;
...
static rapidjson::Value serializeNonTrivialObject(
  ...
  rapidjson::Value result;
  result.SetObject();
  result.AddMember("dmtc_PeriodOffset_r12", serializeNonTrivialObject(obj.dmtc_PeriodOffset_r12, alloc), alloc);
  result.AddMember("ds_OccasionDuration_r12", serializeNonTrivialObject(obj.ds_OccasionDuration_r12, alloc), alloc);
...
static rapidjson::Value serializeNonTrivialObject(const MeasObjectToAddMod& obj, auto& alloc) {
  ...
  case MeasObjectToAddMod__measObject_PR_measObjectCDMA2000:
    result.AddMember("measObjectCDMA2000", serializeNonTrivialObject(obj.measObject.choice.measObjectCDMA2000, alloc),
                     alloc);
    break;
  case MeasObjectToAddMod__measObject_PR_measObjectWLAN_r13:
    result.AddMember("measObjectWLAN_r13", serializeNonTrivialObject(obj.measObject.choice.measObjectWLAN_r13, alloc),
                     alloc);
    break;
...
static rapidjson::Value serializeNonTrivialObject(const ReportQuantityWLAN_r13& obj, auto& alloc) {
  ...
  writeTrivialValue(result, "availableAdmissionCapacityRequestWLAN_r13", obj.availableAdmissionCapacityRequestWLAN_r13,
                    alloc);
...
static rapidjson::Value serializeNonTrivialObject(const QuantityConfigEUTRA& obj, auto& alloc) {
  rapidjson::Value result;
  result.SetObject();
  result.AddMember("filterCoefficientRSRP", obj.filterCoefficientRSRP == nullptr ? 4 : *obj.filterCoefficientRSRP,
                   alloc);
  result.AddMember("filterCoefficientRSRQ", obj.filterCoefficientRSRQ == nullptr ? 4 : *obj.filterCoefficientRSRQ,
                   alloc);
  return result;
}
...
static rapidjson::Value serializeNonTrivialObject(const QuantityConfigUTRA_v1020& obj, auto& alloc) {
  rapidjson::Value result;
  result.SetObject();
  result.AddMember("filterCoefficient2_FDD_r10",
                   obj.filterCoefficient2_FDD_r10 == nullptr ? 4 : *obj.filterCoefficient2_FDD_r10, alloc);
  return result;
}
...
static rapidjson::Value serializeNonTrivialObject(const QuantityConfigEUTRA_v1310& obj, auto& alloc) {
  rapidjson::Value result;
  result.SetObject();
  result.AddMember("filterCoefficientRS_SINR_r13",
                   obj.filterCoefficientRS_SINR_r13 == nullptr ? 4 : *obj.filterCoefficientRS_SINR_r13, alloc);
  return result;
}
...
static rapidjson::Value serializeNonTrivialObject(const QuantityConfigWLAN_r13& obj, auto& alloc) {
  ...
  result.AddMember("filterCoefficient_r13", obj.filterCoefficient_r13 == nullptr ? 4 : *obj.filterCoefficient_r13,
                   alloc);
  return result;
}
...
static rapidjson::Value serializeNonTrivialObject(
  ...
  case MeasObjectToAddModExt_r13__measObject_r13_PR_measObjectCDMA2000_r13:
    result.AddMember("measObjectCDMA2000_r13", serializeNonTrivialObject(obj.choice.measObjectCDMA2000_r13, alloc),
                     alloc);
    break;
...
static void deserialize(MeasConfig::MeasConfig__measScaleFactor_r12& result, const rapidjson::Value& value) {
  ...
  if (it != value.MemberEnd()) {
    ...
    result.present = MeasConfig__measScaleFactor_r12_PR_setup;
    result.choice.setup = it->value.GetInt64();
  }
}
